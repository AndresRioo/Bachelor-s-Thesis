...
if __name__ == '__main__':
    ...
    parser.add_argument('--analysis-dir', type=str, default='results_adaptative_margin')
    ...
    with torch.no_grad():
        ...
        try:
            wandb.init(
                ...
                name=f"adaptive_margin_{today}_{args.work_dir}",
                tags=[
                    args.dataset,
                    args.backbone,
                    f"{args.shot}-shot",
    ...
    with open(results_path, "w") as f:
        ...
        f.write("==================================================\n")
        f.write("ADAPTIVE MARGIN EVALUATION RESULTS\n")
        f.write("==================================================\n\n")
        ...
        f.write("Adaptive Margin Configuration\n")
        f.write("------------------------\n")
        f.write(f"Alpha            : {args.alpha}\n")
        f.write(f"Lambda Margin    : {args.lambda_margin}\n\n")
