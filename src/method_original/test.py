...
if __name__ == '__main__':
    ...
    # EL ENTRENAMIENTO SE HIZO CON METHOD, AHORA ESTA CON METHOD_MARGIN
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help='Generate all t-SNE visualizations'
    )
    ...
    parser.add_argument('--analysis-dir', type=str, default='results_original')
    ...
    ANALYSIS_DIR = os.path.join(
        BASE_DIR,
        args.analysis_dir,
        f"{args.backbone}_{args.dataset}_{args.backbone}_shot{args.shot}"
    )
...
# ==========================================================
    if args.run_tsne == 1:
        ...
        print("vision_vs_Semalign tsne...\n\n")

        print("combined feats shape")
        print(
            combined_feats.shape,
            len(combined_labels)
        )
        generate_tsne_plot(
            combined_feats,
