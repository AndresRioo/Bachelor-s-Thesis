...
if __name__ == '__main__':
    ...
    parser.add_argument('--analysis-dir', type=str, default='results_radio')
    ...
    with torch.no_grad():
        ...
        wandb.run.summary["cluster_margin"] = args.cluster_margin
    ...
    with open(results_path, "w") as f:
        ...
        f.write("==================================================\n")
        f.write("HC-RADIO EVALUATION RESULTS\n")
        f.write("==================================================\n\n")
        ...
        f.write("Hierarchical Clustering Configuration\n")
        f.write("-------------------------------------\n")
        f.write(f"Cluster Level    : {args.cluster_level}\n")
        f.write(f"Cluster Margin   : {args.cluster_margin}\n")
    ...
    df_results = pd.DataFrame([
        {
            ...
            "gain_mix_vs_proto": A_acc_mean - P_acc,
            "gain_gen_vs_proto": G_acc - P_acc
        }
    ])
